...
thelogger.info('SThompson List->Connecting To AERIES to get query student and parents')

connection_string = "DRIVER={SQL Server};SERVER=" + configs['AERIESSQLServer'] + ";DATABASE=" + configs['AERIESDatabase'] + ";UID=" + configs['AERIESUsername'] + ";PWD=" + configs['AERIESPassword'] + ";"
connection_url = URL.create("mssql+pyodbc", query={"odbc_connect": connection_string})
engine = create_engine(connection_url)
thelogger.info('SThompson List->Connecting to AERIES to get Parental emails')
...
thelogger.info('SThompson List->Closed AERIES connection')
...
s.send_message(msg)
thelogger.info('SThompson List->Sent status message')
thelogger.info('SThompson List->Done - Took ' + str(end_of_timer - start_of_timer))
print('Done!!!')
